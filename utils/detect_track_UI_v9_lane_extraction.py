# use: python detect_track_UI_new.py --source ../3_1.mp4 --cfg cfg/yolor_p6.cfg --weights yolor_p6.pt --conf 0.25 --img-size 1280 --view-img
...
def draw_boxes(img, bbox, object_id, identities=None, offset=(0, 0)):
    cv2.line(img, line1[0], line1[1], (0,200,0), 3)
    ...
    for i, box in enumerate(bbox):
        ...
        if len(data_deque[id]) >= 2:
            ...
            if intersect(data_deque[id][0], data_deque[id][1], line1[0], line1[1]):
                cv2.line(img, line1[0], line1[1], (0,100,0), 3)
...
def detect(save_img=False):
    ...
    # This is a lane detection functions
    from lane_detection import get_lanes
    lane_lines, roi = get_lanes(source)
